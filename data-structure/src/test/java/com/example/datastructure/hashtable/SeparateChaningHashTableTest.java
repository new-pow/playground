...
class SeparateChaningHashTableTest {
    ...
    public void constructor_get() throws Exception{
        HashTable<Integer, String> hashTable = new SeparateChaningHashTable<>(10);
        hashTable.put(1, "1번");
    ...
    public void resize() throws Exception{
        HashTable<Integer, String> hashTable = new SeparateChaningHashTable<>(1);
        hashTable.put(1, "1번");
        hashTable.put(2, "2번");
        hashTable.put(3, "3번");
        hashTable.put(4, "4번");
